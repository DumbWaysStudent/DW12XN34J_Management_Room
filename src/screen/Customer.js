...
import { View, Text, FlatList, TextInput, Image, StyleSheet, TouchableOpacity, AsyncStorage, ImageBackground } from 'react-native'
import { Header, Left, Button, Icon, Body, Fab, Card } from 'native-base';
                            ...
                            <Modal isVisible={this.state.isModalVisible} animationIn='slideInUp' animationOut='zoomOut'>
                                <View style={styles.modalView}>
                                    <View style={styles.modalContent}>
                                        <Text style={styles.txtHeaderCustomer}>Add Customer</Text>
                                        <View>
                                            ...
                                            {this.state.image ? <Image source={this.state.image} style={styles.photo}/>: <Text></Text> }
                                                {/* <Image source={this.state.image} style={{width: 70, height: 70 }} /> */}
